...
void main ( void )
{
	...
	#if defined(__PIC18F45K50) || defined (__PIC18F25K50)
	...
	//TRISBbits.TRISB4 = 1;	//No need to explicitly do this since reset state i

	// Para el CdRbot usamos con el PIC18F25K50 usamos el pin RB4
